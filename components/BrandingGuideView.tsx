  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="text-center max-w-2xl mx-auto px-4">
        <h2 className="text-2xl md:text-4xl font-bold mb-4 serif italic whitespace-nowrap overflow-hidden text-ellipsis">채널 아이덴티티</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <div className="bg-slate-900 border border-slate-800 p-5 md:p-6 rounded-2xl lg:col-span-2">
          <h3 className="text-indigo-400 font-bold text-[10px] md:text-xs uppercase tracking-widest mb-4 whitespace-nowrap">메인 컬러 팔레트</h3>
        ...
        {/* Mood Messages */}
        <div className="bg-slate-900 border border-slate-800 p-5 md:p-6 rounded-2xl">
          <h3 className="text-indigo-400 font-bold text-[10px] md:text-xs uppercase tracking-widest mb-4 whitespace-nowrap">브랜드 슬로건</h3>
      ...
      {/* Layout Strategies */}
      <section>
        <h3 className="text-xl md:text-2xl font-bold mb-6 serif px-1">추천 레이아웃 전략</h3>
      ...
      <section className="bg-indigo-900/10 border border-indigo-500/20 p-6 md:p-10 rounded-3xl">
         <h3 className="text-xl md:text-2xl font-bold mb-8 serif text-center whitespace-nowrap">감성 타이틀 뱅크 (무드 라이브러리)</h3>
